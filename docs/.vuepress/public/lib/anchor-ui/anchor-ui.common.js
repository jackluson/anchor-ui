...
const n = ["取消", "关闭"];
function t(e, n, t, a, r, o, l, i, s, d) {
...
const a = {
  ...
  props: {
    ...
    cancelButtonText: { type: String, default: n[0] },
  ...
  methods: {
    handleClose() {
      this.$listeners.close
        ? this.$listeners.close()
        : !0 === this.visible &&
          n.includes(this.cancelButtonText) &&
          !this.beforeClose &&
...
function s(e) {
  return (e, n) =>
    (function(e, n) {
      const t = i ? n.media || "default" : e,
        a = c[t] || (c[t] = { ids: new Set(), styles: [] });
      if (!a.ids.has(e)) {
        a.ids.add(e);
        let t = n.source;
        if (
...
const v = [
  ...
  w = {
    install: async function(n, t = {}) {
      const { isUseElement: a } = t;
      if (a) {
        const t = await Promise.resolve().then(function() {
          return e(require("element-ui"));
        });
        n.use(t);
      }
      v.forEach((e) => {
