<template>
  <pea-table :column="tableData.column" :data="tableData.data">
...
export default {
  ...
  watch: {
    search(newVal, oldVal){
      console.log(`🚀 ~ file: render-header-table.vue ~ line 88 ~ search ~ newVal, oldVal`, newVal, oldVal);
    }
  },
  methods: {
    handleInput(val, row){
      console.log(row, `🚀 ~ file: slot-header-table.vue ~ line 93 ~ handleInput ~ val`, val);
      // this.search = val;
    },
